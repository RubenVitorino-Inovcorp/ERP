...
const breadcrumbs = [
    ...
    { title: 'Nova Proposta', href: '#' },
]

const form = useForm({
    entity_id: '',
    validity_date: props.defaultValidityDate,
    status: 'rascunho',
    lines: [
        {
            article_id: '',
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold tracking-tight text-foreground">
                        Nova Proposta #{{ nextNumber }}
                    </h1>
                    <p class="text-sm text-muted-foreground">
                        Preencha os dados da proposta comercial e as respetivas linhas de artigos.
                    </p>
                </div>
                <Link href="/propostas">
