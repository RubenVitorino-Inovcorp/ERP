...
const breadcrumbs = [
    ...
    { title: `Editar Proposta #${props.proposal.number}`, href: '#' },
]

const form = useForm({
    entity_id: String(props.proposal.entity_id),
    ...
    lines: props.proposal.lines.map((line) => ({
        ...
        cost_price: line.cost_price ? Number(line.cost_price) : null,
        quantity: Number(line.quantity),
        unit_price: Number(line.unit_price),
        vat_rate_id: String(line.vat_rate_id),
    })),
})
...
function submit() {
    form.put(`/propostas/${props.proposal.id}`)
}
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 p-4 md:p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Altere as informações da proposta comercial ou as linhas de artigos.
                    </p>
                </div>
                <Link href="/propostas">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="rounded-xl border bg-card p-6 shadow-sm grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <!-- Validade -->
                    <FormField name="validity_date">
                        <FormItem>
                            <FormLabel>Data de Validade <span class="text-destructive">*</span></FormLabel>
                            <FormControl>
                                <Input type="date" v-model="form.validity_date" :class="{ 'border-destructive': form.errors.validity_date }" />
                            </FormControl>
                            <FormMessage v-if="form.errors.validity_date">{{ form.errors.validity_date }}</FormMessage>
                        </FormItem>
                    </FormField>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm">
                            <thead class="border-b bg-muted/50 text-xs uppercase text-muted-foreground">
                                <tr>
                                    <th class="p-3">Artigo (Ref / Nome) <span class="text-destructive">*</span></th>
                                    <th class="p-3">Fornecedor</th>
                                    <th class="p-3 w-28">P. Custo (€)</th>
                                    <th class="p-3 w-24">Qtd <span class="text-destructive">*</span></th>
                                    <th class="p-3 w-32">P. Venda (€) <span class="text-destructive">*</span></th>
                                    <th class="p-3 w-32">IVA <span class="text-destructive">*</span></th>
