    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6 md:pt-0 max-w-4xl mx-auto w-full">
            <div class="flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-2xl font-semibold tracking-tight">Criar Utilizador</h1>
                    <p class="text-sm text-muted-foreground">
                        Adicione um novo utilizador ao sistema. A password será gerada automaticamente e enviada por email.
                    </p>
                </div>
