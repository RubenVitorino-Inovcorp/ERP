...
const breadcrumbs = [
    ...
    { title: 'Nova Função', href: '/configuracoes/contactos/funcoes/criar' },
];
...
<template>
    <Head title="Nova Função de Contacto" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6 max-w-2xl mx-auto w-full">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-foreground">Nova Função de Contacto</h1>
                <p class="text-sm text-muted-foreground">Adicione uma nova função ou cargo aplicável aos contactos.</p>
            </div>
