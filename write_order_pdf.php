...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="doc-title-container">
                ...
                <div class="doc-number">{{ $order->number }}/{{ \Carbon\Carbon::parse($order->order_date)->format('Y') }}</div>
            </td>
        </tr>
    </table>
    ...
    <div class="client-section">
        <div class="client-name">{{ $order->entity->name ?? 'Nome do Cliente' }}</div>
        <div>{{ $order->entity->address ?? '' }}</div>
        <div>{{ $order->entity->zip_code ?? '' }} {{ $order->entity->city ?? '' }}</div>
    </div>
            ...
            <tr>
                <td style="width: 45%;">
                    <table class="meta-box">
                        ...
                        <tr>
                            <td>{{ $order->entity->number ?? '-' }}</td>
                            <td>{{ $order->entity->nif ?? '-' }}</td>
                        </tr>
                    </table>
                </td>
...
file_put_contents('resources/views/pdf/order.blade.php', $content);
echo "Done for order.\n";
